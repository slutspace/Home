...
import { readCreatorKycEligible } from '../../../../utils/creatorKycGate'
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    setKycEligible(readCreatorKycEligible())
  }, [])
  ...
  const showKycGate = CREATOR_VERIFICATION_PENDING && !kycComplete && kycEligible
